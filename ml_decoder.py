...
class TransformerDecoderLayerOptimal(nn.Module):
    def __init__(self, d_model, nhead=8, dim_feedforward=2048, dropout=0.1, activation="relu",
        ...
        self.self_attn = nn.MultiheadAttention(embed_dim=768, num_heads=8)  # Example initialization
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Optional[Tensor] = None,
        ...
        # Apply cross-attention with the memory
...
class MLDecoder(nn.Module):
    ...
    def forward(self, x):
        ...
        print("embedding_spatial_786 shape:", embedding_spatial_786.shape)
        print("Decoder layer:", self.decoder.layers[0])
